...
export const images = {
	...
	'3vj6GJ_lTa8': {
		raw: 'https://images.unsplash.com/photo-1547053295-bb530ab5af2c?ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY4OTE2MTgxMA&ixlib=rb-4.0.3'
	},
	C5NOq1BKlAk: {
		raw: 'https://images.unsplash.com/photo-1518271851495-c54e908f0547?ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY4OTE2MTkxMQ&ixlib=rb-4.0.3'
	},
	'wzj86-5JVcM': {
	...
	'blink182': {
		raw: 'https://en.wikipedia.org/wiki/Cheshire_Cat_(Blink-182_album)#/media/File:Blink-182_-_Cheshire_Cat_cover.jpg'
	}
} as const;